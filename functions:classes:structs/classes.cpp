// taken from Lawtons Github - amended 
...
class Counter {
  public:
    // default constructor
    // constructors ALWAYS run when the class is used (Counter x;) will run the constructor for x
    // can also define the constructor or functions here - for readability it isn't recommended
    Counter();
...
Counter::Counter() : count(0) { // : count(0) is initializer list (since there is another constructor class it will default to 0 when no param given)
  // count = 0; // no longer needed because of the initializer list!
}

// parameterized constructor implementation
// it will use this when given parameter
